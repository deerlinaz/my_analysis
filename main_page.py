...
page = st.sidebar.selectbox(
    "Выберите страницу",  # Заголовок
    ["📊 Аналитика по нескольким ЕНС ТРУ", "📊 Аналитика по ЕНС ТРУ"]  # Варианты выбора
)

# Обработка выбора
if page == "📊 Аналитика по ЕНС ТРУ":
    from pages import single  # Импортируем страницу
    single.run()  # Запускаем её код

if page == "📊 Аналитика по нескольким ЕНС ТРУ":
    from pages import several  # Импортируем страницу
    several.run()  # Запускаем её код
