...
# Выбор страницы в боковом меню
page = st.sidebar.selectbox(
    "Выберите страницу",
    ["Главная", "📊 Аналитика по одному коду ЕНС ТРУ", "📊 Аналитика по нескольким кодам ЕНС ТРУ"]
)

# Импорт страниц при выборе
if page == "📊 Аналитика по одному коду ЕНС ТРУ":
    from pages import single
    single.run()

elif page == "📊 Аналитика по нескольким кодам ЕНС ТРУ":
    from pages import several
    several.run()
